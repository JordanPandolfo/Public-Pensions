...
#
#   Program to plot model outcomes under hybrid reform scenario
#
#
...
plt.title('Impact of Hybrid Pension Reform on Funded Ratio',fontsize=15)
plt.ylim(.45,1.1)
plt.savefig('fr_hybrid.jpg',format='jpg')
...
plt.plot(np.arange(45),agg_pvl_close,'g',label='Hybrid Reform',lw=3,ls=':')
plt.legend(fontsize=15)
plt.xlabel('Years Since Reform',fontsize=15)
plt.ylabel('Pension Liabilities ($, Billion)',fontsize=15)
plt.title('Impact of Hybrid Pension Reform on Liabilities',fontsize=15)
plt.savefig('pvl_hybrid.jpg',format='jpg')

np.savetxt('pvl_hybrid.csv',agg_pvl_close,delimiter=',')
...
plt.plot(np.arange(45),100*agg_tax_close,'g',label='Hybrid Reform',lw=3,ls=':')
plt.ylim(10,15)
plt.legend(fontsize=15)
plt.xlabel('Years Since Reform',fontsize=15)
plt.ylabel('Total State Tax (%)',fontsize=15)
plt.title('Impact of Hybrid Pension Reform on Taxes',fontsize=15)
plt.savefig('tax_hybrid.jpg',format='jpg')

np.savetxt('taxes_hybrid.csv',agg_tax_close,delimiter=',')
...
plt.title('Welfare Effects of Hybrid Pension, by Sector',fontsize=15)
plt.savefig('welfare_hybrid.jpg',format='jpg')
...
with open( os.path.join(os.getcwd(), "hybrid_reform.tex"), "w"
  )  as file:
...
with open( os.path.join(os.getcwd(), "welfare_hybrid.tex"), "w"
  )  as file:
...
np.savetxt('welfare_pub_hybrid.csv',sector_welfare[0,:])                                     
np.savetxt('welfare_priv_hybrid.csv',sector_welfare[1,:])                                     
